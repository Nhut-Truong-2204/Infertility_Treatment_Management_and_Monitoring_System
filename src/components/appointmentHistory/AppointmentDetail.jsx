...
export default function AppointmentDetailModal({
  ...
  const InfoCard = ({ icon: Icon, title, children, className = "" }) => (
    <div
      className={`bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-200 ${className}`}
    >
            ...
            {loading ? (
                ...
                <div className="mb-6 flex justify-center">
                  {(() => {
                    ...
                    return (
                      <div className="mb-6 flex justify-center">
                        <span
                          className={`inline-flex items-center px-6 py-3 rounded-full text-lg font-semibold shadow-md ${statusInfo.color}`}
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <InfoRow
                        ...
                        value={formatDateTime(
                          appointmentDetail.actualStartTime
                        )}
                      />
                      <InfoRow
                        icon={Clock}
                      ...
                      <InfoRow
                        ...
                        label="Loại lịch hẹn"
                        value={
                          appointmentDetail.appointmentType?.typeName ||
                  ...
                  {appointmentDetail.patientProfile && (
                    <InfoCard icon={User} title="Thông tin bệnh nhân">
                      <InfoRow
                        ...
                        label="Họ và tên"
                        value={
                          appointmentDetail.patientProfile?.fullName ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Mã bệnh nhân"
                        value={
                          appointmentDetail.patientProfile?.patientCode ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Ngày sinh"
                        value={
                          appointmentDetail.patientProfile?.dateOfBirth ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                      ...
                      <InfoRow
                        ...
                        label="Email"
                        value={
                          appointmentDetail.patientProfile?.email ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Điện thoại"
                        value={
                          appointmentDetail.patientProfile?.phoneNumber ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Địa chỉ"
                        value={
                          appointmentDetail.patientProfile?.address ||
                          "Không có thông tin"
                        }
                      />
                      ...
                      {appointmentDetail.patientProfile?.maritalStatus
                        ?.status && (
                        <InfoRow
                          icon={Heart}
                      ...
                      <InfoRow
                        ...
                        label="Lịch sử bệnh"
                        value={
                          appointmentDetail.patientProfile?.medicalHistory ||
                          "Không có"
                        }
                      />
                      <InfoRow
                      ...
                      <InfoRow
                        ...
                        label="Dị ứng"
                        value={
                          appointmentDetail.patientProfile?.allergies ||
                          "Không có"
                        }
                      />
                    </InfoCard>
                  ...
                  <InfoCard icon={Stethoscope} title="Thông tin bác sĩ">
                    <InfoRow
                      ...
                      label="Họ và tên"
                      value={
                        appointmentDetail.doctorUser?.userFullName ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Email"
                      value={
                        appointmentDetail.doctorUser?.userEmail ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Điện thoại"
                      value={
                        appointmentDetail.doctorUser?.userPhoneNumber ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Chuyên khoa"
                      value={
                        appointmentDetail.doctorUser?.specializationName ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Khoa"
                      value={
                        appointmentDetail.doctorUser?.departmentName ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                    ...
                    <InfoRow
                      ...
                      label="Bằng cấp"
                      value={
                        appointmentDetail.doctorUser?.qualifications ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Học vấn"
                      value={
                        appointmentDetail.doctorUser?.education ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      label="Giới thiệu"
                      value={
                        appointmentDetail.doctorUser?.shortBio ||
                        "Không có thông tin"
                      }
                    />
                    <InfoRow
                      ...
                      value={
                        appointmentDetail.doctorUser?.consultationFee != null
                          ? formatCurrency(
                              appointmentDetail.doctorUser.consultationFee
                            )
                          : "Không có thông tin"
                      }
                    />
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <InfoRow
                        ...
                        label="Tên dịch vụ"
                        value={
                          appointmentDetail.serviceDefinition?.serviceName ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Mã dịch vụ"
                        value={
                          appointmentDetail.serviceDefinition?.serviceCode ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Loại dịch vụ"
                        value={
                          appointmentDetail.serviceDefinition?.serviceType
                            ?.typeName || "Không có thông tin"
                        }
                      />
                      <InfoRow
                        icon={CreditCard}
                        label="Phí dịch vụ"
                        value={
                          appointmentDetail.serviceDefinition?.defaultPrice !=
                          null
                            ? formatCurrency(
                                appointmentDetail.serviceDefinition.defaultPrice
                              )
                      ...
                      <InfoRow
                        ...
                        label="Mô tả dịch vụ"
                        value={
                          appointmentDetail.serviceDefinition?.description ||
                          "Không có thông tin"
                        }
                      />
                      <InfoRow
                        ...
                        label="Phòng khám"
                        value={
                          appointmentDetail.roomName || "Không có thông tin"
                        }
                      />
                    </div>
                  </InfoCard>
              ...
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-red-600 text-lg font-medium">
                  Không thể tải chi tiết cuộc hẹn
                </p>
