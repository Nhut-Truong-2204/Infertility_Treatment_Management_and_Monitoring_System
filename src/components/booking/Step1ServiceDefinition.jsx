...
const Step1ServiceDefinition = ({ onSelect, formData }) => {
  ...
  if (loading) {
    return <Loading variant="info" text="Đang tải dịch vụ chi tiết..." />;
  }
...
export default Step1ServiceDefinition;
