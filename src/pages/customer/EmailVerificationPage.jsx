...
import { Button, TextField, Typography, Alert, CircularProgress, Avatar, Stack } from "@mui/material";
...
export default function EmailVerificationPage() {
  ...
  useEffect(() => {
    // Chỉ cần set pageLoading to false sau một khoảng thời gian ngắn
